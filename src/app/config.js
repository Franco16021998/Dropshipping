...
Server = {
	...
	url: domain2+'assets/img/index.php?key=AIzaSyAogCzqr0nyospsB36rzt-1LZKrdOgeNEA',
	delete: domain2+'assets/img/delete.php?key=AIzaSyAogCzqr0nyospsB36rzt-1LZKrdOgeNEA'
}
...
Email = {
	...
	url: domain2+'assets/email/index.php?key=AIzaSyAogCzqr0nyospsB36rzt-1LZKrdOgeNEA'
...
export let Api = {
	...
	url: 'https://mp-prueba-6dc7b-default-rtdb.firebaseio.com/' // YOUR FIREBASE ENDPOINT
...
export let Register = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyAogCzqr0nyospsB36rzt-1LZKrdOgeNEA'
}
...
export let Login = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyAogCzqr0nyospsB36rzt-1LZKrdOgeNEA'
}
...
export let SendEmailVerification = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:sendOobCode?key=AIzaSyAogCzqr0nyospsB36rzt-1LZKrdOgeNEA'
...
export let ConfirmEmailVerification = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:update?key=AIzaSyAogCzqr0nyospsB36rzt-1LZKrdOgeNEA'
...
export let GetUserData = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:lookup?key=AIzaSyAogCzqr0nyospsB36rzt-1LZKrdOgeNEA'
...
export let VerifyPasswordResetCode = {
	...
	url: 'https://identitytoolkit.googleapis.com/v1/accounts:resetPassword?key=AIzaSyAogCzqr0nyospsB36rzt-1LZKrdOgeNEA'
